...
class TestICalendar(TestCase):
    ...
    def test_parse_calendar(self):
        ...
        with path.open() as f:
            ...
            self.assertEqual(result[0].begin.isoformat(), "2011-11-30T00:00:00")
            self.assertTrue(result[0].all_day)

            self.assertEqual(result[1]._name, "Vylet")
            self.assertIsNone(result[1]._location)
            self.assertEqual(result[1].begin.isoformat(), "2015-12-29T10:00:00+01:00")
            ...
            self.assertEqual(result[2].begin.isoformat(), "2015-12-28T11:00:00+01:00")
